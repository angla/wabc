...
public class MenuManager {
	...
	public static void main(String[] args) {
		...
		// 调用接口获取access_token
		AccessToken at = WeixinUtil.getAccessToken(CommKeys.appId, CommKeys.appSecret);
		if (null != at) {
			// 调用接口创建菜单
	...
	public static void  createMenu(){
		// 第三方用户唯一凭证
				String appId = "wx395553491c3a1079";
				// 第三方用户唯一凭证密钥
				String appSecret = "998231fc77726dc470e4797c310860cc";
